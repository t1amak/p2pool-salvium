...
MAKE_SHA256_PRIMARY="dd16fb1d67bfab79a72f5e8390735c49e3e8e70b4945a15ab1f81ddb78658fb3"
MAKE_SHA256_SECONDARY="c79255f6cb550eaa07d6e90d859b8c1abe81658115ae8175e74b67ac22c7ed87"
# Some mirrors serve a recompressed tarball, so accept either known checksum.
...
if [ "$MAKE_FILE_SHA256" != "$MAKE_SHA256_PRIMARY" ] && { [ -z "$MAKE_SHA256_SECONDARY" ] || [ "$MAKE_FILE_SHA256" != "$MAKE_SHA256_SECONDARY" ]; }; then
    echo "Error: SHA256 sum does not match for $MAKE_FILE - expected $MAKE_SHA256_PRIMARY or $MAKE_SHA256_SECONDARY, got $MAKE_FILE_SHA256"
    exit 1
fi
