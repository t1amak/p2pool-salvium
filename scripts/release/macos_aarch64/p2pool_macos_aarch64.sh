...
cc_wrapper="$wrapper_dir/aarch64-apple-darwin25-clang"
cxx_wrapper="$wrapper_dir/aarch64-apple-darwin25-clang++"
as_wrapper="$wrapper_dir/aarch64-apple-darwin25-as"
